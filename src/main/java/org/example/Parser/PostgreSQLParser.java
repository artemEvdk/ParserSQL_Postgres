...
public class PostgreSQLParser extends Parser {
	...
	public final Select_itemContext select_item() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 27021597764747264L) != 0)) {
					{
					setState(140);
					_errHandler.sync(this);
					_la = _input.LA(1);
	...
	public final Function_callContext function_call() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 34979862933913600L) != 0)) {
				{
				setState(240);
				expression();
				setState(245);
	...
	public final Table_referenceContext table_reference() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 281482459348992L) != 0)) {
				{
				{
				setState(265);
				join_clause();
	...
	public final LiteralContext literal() throws RecognitionException {
		...
		try {
			...
			setState(341);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 7881299355238400L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
